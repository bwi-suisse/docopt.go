...
```go
import "github.com/bwi-suisse/docopt-go"
```

To install docopt in your `$GOPATH`:

```console
$ go get github.com/bwi-suisse/docopt-go
```
...
More documentation is available at [godoc.org](https://godoc.org/github.com/bwi-suisse/docopt-go).
